...
<section class="page-heading">
    ...
    <div>
        ...
        <p>
            Cadastre um contato responsável por <?= $e($nomeEmpresa) ?>.
        </p>
...
<section class="form-panel">
    ...
    <header class="form-panel-header">
        ...
        <div>
            ...
            <p>
                Informe os dados utilizados para contato com a empresa.
            </p>
        ...
        <div class="form-grid">
            ...
            <div class="field-group form-grid-full">
                ...
                <div class="responsavel-option">
                    ...
                    <p>
                        Apenas um responsável principal pode existir por empresa.
                    </p>
